...
async function seed() {
  ...
  const plans = [
    ...
    { name: 'Hogar Seguro', type: 'home', description: 'Protección contra incendios, robos y daños estructurales', price: 24.99, coverage: 'Incendio, Robo, Daños por agua, Responsabilidad civil', benefits: 'Reparaciones urgentes, Jardinería', icon: 'home', color: '#22c55e', is_student: 0, popular: 0 },
    ...
    { name: 'Vida Familiar', type: 'life', description: 'Cobertura para toda la familia con beneficios adicionales', price: 34.99, coverage: 'Titular + cónyuge + hijos, Enfermedades graves, Educación', benefits: 'Cobertura dental, Apoyo escolar', icon: 'users', color: '#9333ea', is_student: 0, popular: 0 },
